...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleAppException(AppException ex, HttpServletRequest request) {
        ...
        ErrorResponse body =
                ErrorResponse.of(ex.getStatus(), ex.getClientMessage(), ex.getErrorCode(), request.getRequestURI());
    ...
    public ResponseEntity<ErrorResponse> handleMethodArgumentNotValid(
        ...
        List<ValidationError> fieldErrors = ex.getBindingResult().getFieldErrors().stream()
                ...
                .toList();
        log.warn(
                "[VALIDATION_ERROR] {} {} — {} field error(s)",
                request.getMethod(),
                request.getRequestURI(),
                fieldErrors.size());
    ...
    public ResponseEntity<ErrorResponse> handleUnreadableBody(
        ...
        return HandlerSupport.render(
                HttpStatus.BAD_REQUEST, "Request body is missing or malformed.", "MALFORMED_REQUEST_BODY", request);
    }
    ...
    public ResponseEntity<ErrorResponse> handleMediaTypeNotSupported(
        ...
        return HandlerSupport.render(
                HttpStatus.UNSUPPORTED_MEDIA_TYPE, "Unsupported media type.", "UNSUPPORTED_MEDIA_TYPE", request);
    }
    ...
    public ResponseEntity<ErrorResponse> handleNoResourceFound(
        ...
        return HandlerSupport.render(
                HttpStatus.NOT_FOUND, "The requested resource does not exist.", "ROUTE_NOT_FOUND", request);
    }
    ...
    public ResponseEntity<ErrorResponse> handleMaxUploadSize(
        ...
        return HandlerSupport.render(
                HttpStatus.PAYLOAD_TOO_LARGE, "The uploaded file is too large.", "PAYLOAD_TOO_LARGE", request);
    }
